...
def main() -> None:
    ...
    parser.add_argument("--output-jsonl", default="data/results/legalbench_query_robustness_smoke.jsonl")
    parser.add_argument("--output-summary", default="data/results/legalbench_query_robustness_smoke_summary.json")
    ...
    cases_by_offset = {}
    for row in csv.DictReader(open(args.pairs_csv, encoding="utf-8")):
        off = int(row["offset"])
        ...
        paired.append(
            {
                ...
                "iterations_delta": user.iterations - orig.iterations,

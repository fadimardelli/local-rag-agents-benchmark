...
from src.eval.datasets import iter_legalbench_mini_balanced_cases_window
...
def main() -> None:
    ...
    cases = list(iter_legalbench_mini_balanced_cases_window(offset=args.offset, limit=args.limit))
    if args.model_path:
